    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <div className='flex items-center gap-4'>
      {
        ...
        ? <div className='flex items-center gap-2 cursor-pointer group relative'>
            <img className='w-8 rounded-full' src={userData.image} alt="ProfilePic "></img>
        ...
        : <button onClick={()=>navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-md font-light hidden md:block hover:text-gray-900 hover:bg-green-200 '>Create Account</button>
      }
